...
void SORTING_VISUALIZATION::askForInput( )
{
    ...
    cout << "//////////////////////////////" << endl;
    cout << "\" \" : swap two elements for one time (if any)	/*press the spacebar*/ "<< endl;
    cout << "r, R: reset the process." << endl;
    cout << "i, I : show system information." << endl;
    cout << "< : decrease mMaxValue by 1." << endl;
    cout << "> : increase mMaxValue by 1. The maximum value of mMaxValue is 20." << endl;
}
...
void SORTING_VISUALIZATION::checkAndSwapTwoElements( int index )
{
    ...
    //
    if (v0 > v1 && index < mNumElements) swap(mNumbers[index], mNumbers[index + 1]);
}
...
void SORTING_VISUALIZATION::processOneSwapStep( )
{
    ...
    if (getCurrentElementIndex() >= getMaxNonHandledElementIndex() - 1) {
        mCurrentIndex = 0;
